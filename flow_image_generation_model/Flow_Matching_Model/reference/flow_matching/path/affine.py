...
class AffineProbPath(ProbPath):
    ...
    def sample(self, x_0: Tensor, x_1: Tensor, t: Tensor) -> PathSample:
        ...
        alpha_t = expand_tensor_like(           # 把input_tensor的维度调整到与expand_to的维度一致
        ...
        x_t = sigma_t * x_0 + alpha_t * x_1 # 高斯分布，均值为alpha_t * x_1（目标图片），标准差为sigma_t，通过重采样得到特定时刻t的x_t
        dx_t = d_sigma_t * x_0 + d_alpha_t * x_1 # dx_t/dt
